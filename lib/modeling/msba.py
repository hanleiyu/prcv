...
from .backbones.se_layer import SELayer, MultiScaleLayer_v2, SELayer_Local, BasicConv2d,init_params
...
class MSBA(nn.Module):
    ...
    def __init__(self, num_classes, last_stride, model_path, neck, neck_feat, model_name, pretrain_choice, cfg):
        ...
        # global feature classifier ( circle loss )
        # The rest classifier ( conventional cross entropy loss for convenient and consistency)
    ...
    def forward(self, x, label=None):
        ...
        if self.training:
            ...
            lf_xent.extend([cls_score, inv_score, cls_score_br1, cls_score_br2])  # MMNet-a loss
